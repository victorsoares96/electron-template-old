...
import { changeDirection } from '@src/store/settings/settings.slice';
import { ThemeDirection } from '@src/store/settings/types';
...
export default function SettingDirection() {
  ...
  return (
    <RadioGroup
      ...
      onChange={event =>
        dispatch(changeDirection(event.target.value as ThemeDirection))
      }
    >
