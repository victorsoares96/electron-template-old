...
import snackContent from '@src/components/SnackContent';
import { store } from '@src/store/index';
import { enqueueSnackbar } from '@src/store/notification/notification.slice';
import { logout } from '@src/store/session/session.slice';
            ...
            enqueueSnackbar({
              options: {
                content: snackContent({
                  ...
                  content:
                    'Por favor, verifique se o seu usuário e senha estão corretos',
                }),
                variant: 'error',
              },
            }),
