...
import { changeLayout } from '@src/store/settings/settings.slice';
import { ThemeLayout } from '@src/store/settings/types';
...
export default function SettingLayout() {
  ...
  return (
    <RadioGroup
      ...
      value={themeLayout}
      onChange={event =>
        dispatch(changeLayout(event.target.value as ThemeLayout))
      }
    >
